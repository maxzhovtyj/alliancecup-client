...
export class ProductService {
    ...
    static async getProducts(id, createdAt, price, size, characteristic, search) {
        try {
            ...
            const reqUrl = `/api/products?category=${id}&createdAt=${createdAt}&priceRange=${price}&size=${size}&characteristic=${characteristic}&search=${search}`

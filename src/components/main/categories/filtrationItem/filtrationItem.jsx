...
function FiltrationItem({onClick, item: {filtrationTitle, imgUrl, infoDescription, filtrationListId}}) {
    if (!imgUrl) {
        imgUrl = "https://www.fil.ion.ucl.ac.uk/wp-content/uploads/2019/05/grey-background-750x500.jpg"
    }
    return (
        <div onClick={() => onClick(infoDescription, filtrationListId)} className={classes.filtrationItem}>
